const e = async t => {
  let n;
  import('./install-dialog-19322187.js');
  try {
    n = await navigator.serial.requestPort()
  } catch (n) {
    return 'NotFoundError' === n.name ?
        void import('./index-54fb20b9.js')
            .then((n => n.openNoPortPickedDialog((() => e(t))))) :
  ...
  o.port = n, o.manifestPath = t.manifest || t.getAttribute('manifest'),
...
class t extends HTMLElement {
  connectedCallback() {
    ...
    if (this.renderRoot = this.attachShadow({mode: 'open'}),
    ...
    n.addEventListener('click', (async t => {t.preventDefault(), e(this)})),
        n.name = 'activate';
    const o = document.createElement('button');
    if (o.innerText = 'CONNECT', n.append(o),
